(function(){
  ...
  var ROUTE={
    ...
    fsbo:{label:'Is this a For Sale By Owner (FSBO) transaction?',hint:'FSBO loan purchases have their own buyer and seller fee section.',help:'Choose Yes when the sale is being handled as For Sale By Owner rather than through the normal purchase fee path.',choices:[['yes','Yes, FSBO'],['no','No']]},
