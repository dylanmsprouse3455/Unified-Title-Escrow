...
(function () {
  ...
  function installLauncher() {
    ...
    toolboxButton.onclick = function () {
      ...
      document.getElementById("openFileTrackerTool").onclick = function () {
